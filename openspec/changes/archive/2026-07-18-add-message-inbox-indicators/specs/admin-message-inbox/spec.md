...
The system SHALL present actionable visual message-state information in Daily Operations for the authenticated admin.

#### Scenario: Unread conversations are visible
- **WHEN** one or more student conversations contain unread messages for the authenticated admin
- **THEN** Student Messages displays an unread conversation count
...
- **WHEN** Daily Operations renders Student Messages
...
- **THEN** Daily Operations displays an empty state that explains that no student messages are available
