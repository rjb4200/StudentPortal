...
**Purpose:** Allow admin users to upload image and document files directly to Supabase Storage from the quiz photo and resource document editors, with public read access for student-facing components.
