...
**Purpose:** Allow admin users to permanently delete student records with 2-stage confirmation, and remove the inline Notes column from the Student Roster UI.
