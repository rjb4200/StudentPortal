...
## Purpose
Student and admin shift cancellation with source tracking (`cancelled_by` field), distinct calendar cell styling, and admin Action Required feed visibility for student-initiated cancellations of approved shifts.
## Requirements
