# shift-modal-date-picker Specification

## Purpose
Native date input in the shift request modal with class window constraints, and removal of duplicate "Schedule a Shift" button from the dashboard toolbar.
