...
End-to-end onboarding completion experience including auth user creation on quiz finish, magic link delivery, admin-configurable completion screen, pending-approval dashboard, and login email validation.
## Requirements
