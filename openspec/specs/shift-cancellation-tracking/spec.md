# shift-cancellation-tracking Specification

## Purpose
Track who initiated a shift cancellation via the `cancelled_by` field and surface student-initiated cancellations in the admin Action Required feed.
## Requirements
