...
Define real-time message delivery and live unread count updates for students and admins using Supabase Realtime, with graceful degradation when the real-time connection is unavailable.
