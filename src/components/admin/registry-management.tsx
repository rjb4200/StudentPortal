...
type ClassForm = { trainingSiteId: string; instructorId: string; name: string; level: string; classStartDate: string; rideTimeEndDate: string; notes: string };
...
const emptyClass = (): ClassForm => ({ trainingSiteId: '', instructorId: '', name: '', level: '', classStartDate: '', rideTimeEndDate: '', notes: '' });
...
export function RegistryManagement() {
  ...
  const openEditor = (table: RegistryTable, row?: Site | Instructor | TrainingClass) => {
    ...
    if (table === 'training_sites') {
      ...
      setClassForm(trainingClass ? { trainingSiteId: trainingClass.training_site_id, instructorId: trainingClass.instructor_id, name: trainingClass.name, level: trainingClass.level ?? '', classStartDate: trainingClass.class_start_date, rideTimeEndDate: trainingClass.ride_time_end_date, notes: trainingClass.notes ?? '' } : emptyClass());
    }
    setEditor({ table, row });
  };
