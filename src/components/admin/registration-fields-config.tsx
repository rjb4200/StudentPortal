              ...
              <div key={field.id} className={`rounded-lg border p-3 ${field.is_permanent ? 'bg-gray-50' : ''}`}>
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1">
                    <button onClick={() => toggleActive(field)} className={`rounded-full px-2 py-0.5 text-xs font-bold ${field.is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'}`}>
